...
message2 = """
*RG* autenticado e *COLORIDO* (*nao pode ser preto e branca*) ou RG oferecido pelo sistema do Governo Federal (Gov.br);
*ATESTADO MEDICO* datado de 2024, contento *Esta apto a pratica esportiva no ano de 2024*
*AUTORIZAÇÃO DO MENOR*, *deve ser assinada pelo responsável legal*, que deverá via cartório *reconhecer firma*;
Assim que tiver todos os documentos autenticados envia cópia digital *DE BOA QUALIDADE*  aqui no meu whatsapp.;
"""
